...
public class PathRepositoryCreationIT {
    ...
    public void verifyTheValidityOfInitDataMethod() {
        ...
        List<Edge> edges = Collections.singletonList(edge0);
        Graph graph = new Graph(vertices, edges);
        List<Traffic> traffic = Collections.singletonList(new Traffic(1, "A", "B", 3f));
        ...
        PathRepositoryCreation pathRepositoryCreation = new PathRepositoryCreation(txManager, trafficDAO, startUpDataMigrationService);
